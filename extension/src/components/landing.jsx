...
const Landing = ({ step, setStep }) => {
    ...
    return (
        <div className="~w-90 w-100 bg-gradient-to-b from-neutral-800/90 to-neutral-900/90 backdrop-blur-xl text-white min-h-[400px] shadow-2xl border border-neutral-700/50 p-4">
            {/* Header */}
            <div className="flex justify-between items-center border-b border-neutral-700/50 pb-4">
                ...
                <button
                    className="text-neutral-400 hover:text-white hover:bg-neutral-800 px-3 py-1 rounded-md text-md flex items-center gap-2"
                    onClick={() => setStep(2)}
                >
                    <ChartNoAxesColumnDecreasing className="w-4 h-4" />
                    Reports
                </button>
            </div>
